...
import { View, StyleSheet, Image, ActivityIndicator, Dimensions, TouchableOpacity, Text, ScrollView, SafeAreaView, Linking } from 'react-native';
...
const PropertyDetails = ({ route, customStyles }) => {
  ...
  Geocoding.init('AIzaSyBzE9bz84Bdwy24I5DAjwVhgjijqgrEEdU');
      ...
      <ScrollView style={styles.scrollcontainer}>
        <View style={styles.topbuttons}>
          <View style={styles.sharebtncontainer}>
            <TouchableOpacity style={styles.sharebtn} onPress={sharePressed}>
        ...
        <View style={styles.propertydescriptioncontainer}>
          ...
          <View style={styles.propertydescriptionmapsection}>
            <Text style={styles.propertydescriptionmainfeaturestitle}>
...
const styles = StyleSheet.create({
  ...
  imagescontainer: {
    marginBottom: -575, // Adjust this value as needed
  },
  imageslider: {
    width: '100%',
    height: 270,
  ...
  pricecontainer: {
    ...
    backgroundColor: Color.ccbgcolor,
    borderTopWidth: 1,
    borderTopColor: Color.ccbgcolor,
  },
